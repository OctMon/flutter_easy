...
import 'base_date_widget.dart';
import 'base_datetime_widget.dart';
import 'base_time_widget.dart';

/// 时间选择模式枚举
enum BaseDateTimePickerMode {
  /// Display DatePicker
  date,
...
class BaseDatePicker {
  ...
  /// pickerMode: [BaseDateTimePickerMode] display mode: date(DatePicker)、time(TimePicker)、datetime(DateTimePicker)
  /// pickerTheme: [BasePickerTitleConfig] the theme of date time picker
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    this.minuteDivider,
    this.dateFormat,
    this.pickerMode = BaseDateTimePickerMode.date,
  ...
  final BaseDateTimePickerMode pickerMode;
  BasePickerTitleConfig? pickerTitleConfig;
  ...
  Widget build(BuildContext context) {
    ...
    switch (route.pickerMode) {
      ...
      case BaseDateTimePickerMode.datetime:
        pickerWidget = BaseDateTimeWidget(
          minDateTime: route.minDateTime,
          maxDateTime: route.maxDateTime,
          initDateTime: route.initialDateTime,
          dateFormat: route.dateFormat,
