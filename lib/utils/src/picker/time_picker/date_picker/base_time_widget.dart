...
class BaseTimeWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _BaseTimeWidgetState(this.minDateTime,
      this.maxDateTime, this.initDateTime, this.minuteDivider);
}

class _BaseTimeWidgetState extends State<BaseTimeWidget> {
  ...
  _BaseTimeWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initTime,
      int? minuteDivider) {
    if (minTime == null) {
