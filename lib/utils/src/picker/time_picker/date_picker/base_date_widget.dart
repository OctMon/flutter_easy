...
class BaseDateWidget extends StatefulWidget {
  BaseDateWidget({
    Key? key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _BaseDateWidgetState(
      this.minDateTime, this.maxDateTime, this.initialDateTime);
}

class _BaseDateWidgetState extends State<BaseDateWidget> {
