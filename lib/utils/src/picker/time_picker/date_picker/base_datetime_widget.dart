...
class BaseDateTimeWidget extends StatefulWidget {
  BaseDateTimeWidget({
    Key? key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _BaseDateTimeWidgetState(
      this.minDateTime, this.maxDateTime, this.initDateTime, minuteDivider);
}

class _BaseDateTimeWidgetState extends State<BaseDateTimeWidget> {
  ...
  _BaseDateTimeWidgetState(DateTime? minTime, DateTime? maxTime,
