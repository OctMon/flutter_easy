...
import 'base_time_range_side_widget.dart';

/// 时间范围选择 TimeRange widget.
// ignore: must_be_immutable
class BaseTimeRangeWidget extends StatefulWidget {
  /// 可选最小时间
...
class _TimePickerWidgetState extends State<BaseTimeRangeWidget> {
