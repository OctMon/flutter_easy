...
import 'base_date_range_side_widget.dart';
...
class BaseDateRangeWidget extends StatefulWidget {
  /// 可选最小时间
...
class _DatePickerWidgetState extends State<BaseDateRangeWidget> {
  ...
  Widget _renderPickerView(BuildContext context) {
    ...
    if (widget.pickerTitleConfig!.title != null ||
      ...
      Widget titleWidget = BasePickerTitle(
        ...
        child: BasePicker.builder(
          ...
          itemBuilder: (context, index) {
            return Container(
              ...
              child: Text(
                widget.pickerTitleConfig!.toLocalized,
                style: widget.themeData!.itemTextStyle,
              ),
            );
          },
